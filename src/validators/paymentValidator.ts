...
export const validateCreateLinkRequest = (data: Record<string, unknown>): joi.ValidationResult => {
...
export const validateCallback = (data: Record<string, unknown>): joi.ValidationResult => {
    const schema = joi.object({
        requestId: joi.string().max(64).required(),
...
export const validateQrisStatus = (data: Record<string, unknown>): joi.ValidationResult => {
    const schema = joi.object({
        requestId: joi.string().max(64).required(),
...
export const cancelQrisValidator = (data: Record<string, unknown>): joi.ValidationResult => {
    const schema = joi.object({
        requestId: joi.string().max(64).required(),
        merchantId: joi.string().max(10).required(),
        storeId: joi.string().max(30).optional(),
...
export const validateGenerateVA = (data: Record<string, unknown>): joi.ValidationResult => {
    const schema = joi.object({
        requestId: joi.string().max(64).required(),
        merchantId: joi.string().max(20).required(),
        storeId: joi.string().max(30).optional(),
...
export const validateVaStatus = (data: Record<string, unknown>): joi.ValidationResult => {
    const schema = joi.object({
        requestId: joi.string().max(64).required(),
        merchantId: joi.string().max(10).required(),
        storeId: joi.string().max(30).optional(),
...
export const validateStaticVA = (data: Record<string, unknown>): joi.ValidationResult => {
    const schema = joi.object({
        requestId: joi.string().max(64).required(),
        merchantId: joi.string().max(20).required(),
        storeId: joi.string().max(30).optional(),
...
export const validateCreateVASNAP = (data: Record<string, unknown>): joi.ValidationResult => {
    const schema = joi.object({
...
export const validatedeleteVASNAP = (data: Record<string, unknown>): joi.ValidationResult => {
    const schema = joi.object({
        partnerServiceId: joi.string().max(8).required(),
        customerNo: joi.string().max(20).required(),
        virtualAccountNo: joi.string().max(28).required(),
...
export const validateVaSNAPStatus = (data: Record<string, unknown>): joi.ValidationResult => {
    const schema = joi.object({
        partnerServiceId: joi.string().max(8).required(),
        customerNo: joi.string().max(20).required(),
        virtualAccountNo: joi.string().max(28).required(),
...
export const validateSnapDelete = (data: Record<string, unknown>): joi.ValidationResult => {
    const schema = joi.object({
...
export const validatePaymentVASNAP = (data: Record<string, unknown>): joi.ValidationResult => {
    const schema = joi.object({
        partnerServiceId: joi.string().max(8).required(),
        customerNo: joi.string().max(20).required(),
        virtualAccountNo: joi.string().max(28).required(),
...
export const validateCCStatus = (data: Record<string, unknown>): joi.ValidationResult => {
    const schema = joi.object({
        requestId: joi.string().max(64).required(),
        merchantId: joi.string().max(10).required(),
        storeId: joi.string().max(30).optional(),
...
export const validateEMoneyRequest = (data: Record<string, unknown>): joi.ValidationResult => {
    const schema = joi.object({
        requestId: joi.string().max(64).required(),
        merchantId: joi.string().max(20).required(),
        storeId: joi.string().max(30).optional(),
...
export const validateEmoneyStatus = (data: Record<string, unknown>): joi.ValidationResult => {
    const schema = joi.object({
        requestId: joi.string().max(64).required(),
        merchantId: joi.string().max(10).required(),
        storeId: joi.string().max(30).optional(),
...
export const validateEMoneyRefund = (data: Record<string, unknown>): joi.ValidationResult => {
    const schema = joi.object({
        requestId: joi.string().max(64).required(),
        merchantId: joi.string().max(20).required(),
        storeId: joi.string().max(30).optional(),
